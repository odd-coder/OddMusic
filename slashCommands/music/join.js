...
module.exports = {
    ...
    run: async (client, interaction, args, prefix) => {
        try {
            ...
            if(oldConnection) return interaction.reply({ ephemeral: true, content:`<:oddno:968555009908293652> **I'm already connected in <#${oldConnection.joinConfig.channelId}>**!`}).catch(() => null);
            ...
            interaction.reply({ ephemeral: false, content:"<:oddse:968557685500948520> **Joined your VC!**"}).catch(() => null);
        } catch(e) { 
            console.error(e);
