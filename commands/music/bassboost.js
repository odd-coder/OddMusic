...
module.exports = {
    ...
    run: async (client, message, args, prefix) => {
        ...
        if(args[0] === undefined || isNaN(args[0]) || Number(args[0]) < 0 || Number(args[0]) > 20) return message.reply(`<:oddno:968555009908293652> **No __valid__ Bassboost-Level between 0 and 20 db provided!** Usage: \`${prefix}bassboost 6\``).catch(() => null);
        ...
        return message.reply(`<:oddv:968567000307736607> **Successfully changed the Bassboost-Level to \`${bassboost}db\`**`).catch(() => null);
    },
};