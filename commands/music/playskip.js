...
module.exports = {
    ...
    run: async (client, message, args, prefix) => {
        ...
        if(!args[0]) return message.reply(`<:oddno:968555009908293652> Please add the wished Music via: \`${prefix}playskip <Name/Link>\``).catch(() => null);
        ...
        try {
            ...
            if(!playlist) {
                ...
                return m.edit(`<:oddse:968557685500948520> **Now playing and skipping to: __${song.title}__** - \`${song.durationFormatted}\``).catch(() => null);
            } 
            /* FOR PLAYLIST REQUEST */
                ...
                oldConnection.state.subscription.player.stop();
                // edit the loading message                    
                return m.edit(`<:oddmu:968552025723928647> **Now playing and skipping to: __${song.title}__** - \`${song.durationFormatted}\`\n> **Added \`${playlist.videos.length - 1} Songs\` from the Playlist:**\n> __**${playlist.title}**__`).catch(() => null);
            }
